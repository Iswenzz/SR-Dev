...
opening()
{
	...
	noti = SpawnStruct();
	noti.titleText = "mp_dr_lazycave";
	noti.notifyText = "A map by Rex109, made from a dream";
	noti.duration = 5;
...
endingplatform()
{
	...
	startplattrig delete();
	while(1)
	{
		plat movey (-910,3,1,1);
		wait(6);
		plat movey (910,3,1,1);
		wait(6);
	}
...
trap1()
{
	...
	traptrig1 setHintString ("^1Trap activated!");
	while(1)
	{
		trap1 rotateRoll (2160,6);
		wait(9);
	}
}
...
trap2()
{
	...
	traptrig2 setHintString ("^1Trap activated!");
	while(1)
	{
		trap2 movez (-1000,3,0,0);
		wait(5);
		trap2 movez (1000,3,0,0);
		wait(5);
	}
...
trap3()
{
	...
	traptrig3 setHintString ("^1Trap activated!");
	trap3 delete();
}
...
trap4()
{
	...
	traptrig4 setHintString ("^1Trap activated!");
	trap4 movez (228,1,0,0);
}
...
trap5()
{
	...
	traptrig5 setHintString ("^1Trap activated!");
	while(1)
	{
		trap5_1 rotateYaw (360,2);
		trap5_2 rotateYaw (-360,2);
		wait(2);
	}
}
...
trap6()
{
	...
	traptrig6 setHintString ("^1Trap activated!");
	trap6 movez (-311,0.5,0,0);
	wait(4);
	trap6 movez (311,0.5,0,0);
}
