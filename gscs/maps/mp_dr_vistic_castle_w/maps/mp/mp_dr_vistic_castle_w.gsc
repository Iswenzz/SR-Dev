...
main()
{
	...
	level.music[0]["song"]	="Wham - Last Christmas";
	level.music[0]["alias"]	="wham";
	level.music[1]["song"]	="Brennan Heart - Broken";
	level.music[1]["alias"]	="hardstyleb2";
	level.music[2]["song"]	="J Cole - Apparently";
	level.music[2]["alias"]	="apparently";
	level.music[3]["song"]	="Our last night - Ghost In The Machine";
	level.music[3]["alias"]	="ghochine";
	level.music[4]["song"]	="Alok - Never Let Me Go";
	level.music[4]["alias"]	="alok";
	level.music[5]["song"]	="Martin Solveig - Intoxicated";
	level.music[5]["alias"]	="intoxicated";
...
jump_room_battle()
{
    ...
    while(1)
    {
        ...
        if(!isdefined(level.entertext)||!level.entertext)
        {
            ...
            iprintln("^1Now playing:^7 Tiesto ^1-^7 Boom");
    ...
    while(1)
    {
       level.sniper_trig waittill("trigger",player);
        ...
        if(!isdefined(level.entertext)||!level.entertext)
        {
            ...
            iprintln("^1Now playing:^7 Martin Garrix ^1-^7 Byte");
...
rpg_room_battle()
{
    ...
    while(1)
    {
        ...
        if(!isdefined(level.entertext)||!level.entertext)
        {
            ...
            iprintln("^1Now playing:^7 Tujamo ^1-^7 Drop That Low");
...
sgun_room_battle()
{
    ...
    while(1)
    {
        ...
        if(!isdefined(level.entertext)||!level.entertext)
        {
            ...
            ambientstop();
            ambientplay("warriors");
            level.canPlaySound=false;

            iprintln("^1Now playing:^7Solence ^1-^7 Warriors");
...
knife_room_battle()
{
    ...
    while(1)
    {
        ...
        if(!isdefined(level.entertext)||!level.entertext)
        {
            ...
            iprintln("^1Now playing:^7 Eminem ^1-^7 'Till I Collapse");
...
p_room()
{
	...
	trigger waittill ("trigger", player );
	iPrintlnBold(" ^7Activator entered the ^6 Porn room ");
}
...
{
	wait 9;
	iprintlnBold("^5Merry christmas and happy new year!");
	wait 2;
	...
	wait 5;
	iprintln("^7 Thanks to Sheep Wizard for helping me on the music menu ");
	wait 15;
...
snowy()
{
	...
	snow10 = getEnt ( "snow10", "targetname" );
	snow11 = getEnt ( "snow11", "targetname" );
	snow12 = getEnt ( "snow12", "targetname" );
	snow13 = getEnt ( "snow13", "targetname" );
	snow14 = getEnt ( "snow14", "targetname" );
	snow15 = getEnt ( "snow15", "targetname" );
	snow16 = getEnt ( "snow16", "targetname" );
	snow17 = getEnt ( "snow17", "targetname" );
	snow18 = getEnt ( "snow18", "targetname" );
	snow19 = getEnt ( "snow19", "targetname" );
	snow20 = getEnt ( "snow20", "targetname" );
	snow21 = getEnt ( "snow21", "targetname" );
	snow22 = getEnt ( "snow22", "targetname" );
	snow23 = getEnt ( "snow23", "targetname" );
	snow24 = getEnt ( "snow24", "targetname" );
	snow25 = getEnt ( "snow25", "targetname" );
	snow26 = getEnt ( "snow26", "targetname" );
	snow27 = getEnt ( "snow27", "targetname" );
	snow28 = getEnt ( "snow28", "targetname" );
	snow29 = getEnt ( "snow29", "targetname" );
	trigger waittill ("trigger", player);
	wait 1;
	...
	playfx(level.snow,snow10.origin);
	playfx(level.snow,snow11.origin);
	playfx(level.snow,snow12.origin);
	playfx(level.snow,snow13.origin);
	playfx(level.snow,snow14.origin);
	playfx(level.snow,snow15.origin);
	playfx(level.snow,snow16.origin);
	playfx(level.snow,snow17.origin);
	playfx(level.snow,snow18.origin);
	playfx(level.snow,snow19.origin);
	playfx(level.snow,snow20.origin);
	playfx(level.snow,snow21.origin);
	playfx(level.snow,snow22.origin);
	playfx(level.snow,snow23.origin);
	playfx(level.snow,snow24.origin);
	playfx(level.snow,snow25.origin);
	playfx(level.snow,snow26.origin);
	playfx(level.snow,snow27.origin);
	playfx(level.snow,snow28.origin);
	playfx(level.snow,snow29.origin);
}